...
public function records()
{
    ...
    foreach ($records as &$row) {
        ...
        $row->current_count_doc_month = DB::connection('tenant')
            ->table('documents')
            ->whereBetween('date_of_issue', [$current_month_start, $current_month_end])
            ->count();
        ...
        if ($row->start_billing_cycle) {
            ...
            $row->count_doc_month = DB::connection('tenant')
                ->table('documents')
                ->whereBetween('date_of_issue', [$init_formatted, $end_formatted])
                ->count();
