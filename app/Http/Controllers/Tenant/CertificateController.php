...
class CertificateController extends Controller
{
    ...
    public function uploadFile(Request $request)
    {
        if ($request->hasFile('file')) {
            try {
                ...
                $certificate_due = $request->input('certificate_due');
                ...
                if ($certificate_due) {
                    $company->certificate_due = $certificate_due;
                }
                $company->save();
    ...
    public function saveDueDate(Request $request)
    {
        $certificate_due = $request->input('certificate_due');
        try {
            $company = Company::active();
            $company->certificate_due = $certificate_due ?: null;
            $company->save();
            return [
                'success' => true,
                'message' => __('app.actions.update.success'),
            ];
        } catch (Exception $e) {
            return [
                'success' => false,
