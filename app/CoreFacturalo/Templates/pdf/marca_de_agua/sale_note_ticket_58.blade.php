...
<table class="full-width">
    <tr>
        <td width="" class="pt-3"><p class="desc-14">F. Emisión:</p></td>
        <td width="" class="pt-3"><p class="desc-14">{{ $document->date_of_issue->format('Y-m-d') }}</p></td>
    </tr>

    @if ($document->due_date)
        <tr>
            <td width="" class="pt-3"><p class="desc-14">F. Vencimiento:</p></td>
            <td width="" class="pt-3"><p class="desc-14">{{ $document->getFormatDueDate() }}</p></td>
        </tr>
    @endif

    <tr>
        <td class="align-top"><p class="desc-14">Cliente:</p></td>
        <td><p class="desc-14">{{ $customer->name }}</p></td>
    </tr>
    <tr>
        <td><p class="desc-14">{{ $customer->identity_document_type->description }}:</p></td>
        <td><p class="desc-14">{{ $customer->number }}</p></td>
    </tr>
    @if ($customer->address !== '')
        <tr>
            <td class="align-top"><p class="desc-14">Dirección:</p></td>
            <td>
                <p class="desc-14">
    ...
    <tr>
        <td class="align-top"><p class="desc-14">N° Placa:</p></td>
        <td><p class="desc-14">{{ $document->plate_number }}</p></td>
    </tr>
    @endif
    @if ($document->purchase_order)
        <tr>
            <td><p class="desc-14">Orden de Compra:</p></td>
            <td><p class="desc-14">{{ $document->purchase_order }}</p></td>
        </tr>
    @endif
    @if ($document->observation)
        <tr>
            <td><p class="desc-14">Observación:</p></td>
            <td><p class="desc-14">{{ $document->observation }}</p></td>
        </tr>
    @endif
    @if ($document->reference_data)
        <tr>
            <td class="align-top"><p class="desc-14">D. Referencia:</p></td>
            <td>
                <p class="desc-14">
...
<table class="full-width mt-10 mb-10">
    ...
    @foreach($document->items as $row)
        <tr>
            <td class="text-center desc-14 align-top">
            ...
            <td class="text-center desc-14 align-top">{{ $row->item->unit_type_id }}</td>
            <td class="text-left desc-14 align-top">
            ...
            <td class="text-right desc-14 align-top">{{ number_format($row->unit_price, 2) }}</td>
            <td class="text-right desc-14 align-top">{{ number_format($row->total, 2) }}</td>
        </tr>
        <tr>
